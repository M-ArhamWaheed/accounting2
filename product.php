              ...
              <input type="hidden" id="product_add_from" value="page">
                 ...
                 <div class="form-group row">
                  <div class="col-sm-4 mb-3 mb-sm-0">
                      <label for="">MM</label>
                      <input type="number" class="form-control" id="product_mm" placeholder=" MM" name="product_mm"   value="<?=@$fetchproduct['product_mm']?>">                       
                      </div>
                    <div class="col-sm-4 mb-3 mb-sm-0">
                      <label for="">Inch</label>
                      <input type="number" class="form-control" id="product_inch" placeholder="Inch" name="product_inch"   value="<?=@$fetchproduct['product_inch']?>">                       
                      </div>
                      <div class="col-sm-4 mb-3 mb-sm-0">
                      <label for="">Length(meter)</label>
                      <input type="number" class="form-control" id="product_meter" placeholder="Length in Meter" name="product_meter"   value="<?=@$fetchproduct['product_meter']?>">                       
                      </div>
                 ...
                 <div class="form-group row">
                  <div class="col-sm-4 mb-3 mb-sm-0">
                    ...
                    <div class="col-sm-4 mb-3 mb-sm-0">
                      ...
                      <input type="text" class="form-control" id="f_days" placeholder="15 Days Sale Rate" name="f_days"   value="<?=@$fetchproduct['f_days']?>">                       
                      </div>
                      <div class="col-sm-4 mb-3 mb-sm-0">
                      <label for="">30 Days Sale Rate</label>
                      <input type="text" class="form-control" id="t_days" placeholder="30 Days Sale Rate" name="t_days"   value="<?=@$fetchproduct['t_days']?>">                       
                      </div>
